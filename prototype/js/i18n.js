...
const STRINGS = {
  en: {
    ...
    inventory: {
      ...
      intro: 'Construction requires stocked materials. Paid Earth market: Fe and H₂O only (separate from periodic aid). Export sulfur for credits; early on you may need to wait for ISRU acid split or Earth aid.',
  ...
  ja: {
    ...
    inventory: {
      title: '在庫・地球市場',
      intro: '建設には在庫の材料が必要です。有料の地球市場では Fe と H₂O のみ購入可能（定期援助とは別）。硫黄を輸出してクレジットを得られますが、序盤は ISRU の硫酸分解や地球援助を待つこともあります。',
