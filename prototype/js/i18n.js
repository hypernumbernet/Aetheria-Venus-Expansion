...
const STRINGS = {
  en: {
    ...
    panel: {
      ...
      coatingDisabledNoCorrosion: 'No corrosion on this unit',
      ...
      earthAidEtaShort: 'Aid in {eta}t (+{h2o} H₂O, +{iron} Fe)',
      earthAidNone: 'No aid',
  ...
  ja: {
    ...
    panel: {
      ...
      coatingDisabledNoCorrosion: 'このユニットに腐食なし',
      ...
      earthAidEtaShort: '次の援助まで {eta}（+{h2o} H₂O、+{iron} Fe）',
      earthAidNone: '援助なし',
